...
```{python}
closest_centroid = dists.argsort()[:,1]
closest_centroid
```
...
* Cluster 1 has medium bill, long flipper

* Cluster 2 has short bill, short flipper

* Cluster 3 has long bill, shortish flipper
